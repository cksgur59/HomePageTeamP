...
public class FreeboardDAO {
	...
	private int getNum(Connection conn) {
		int num = -1;
		PreparedStatement pstmt = null;
		String sql = "SELECT NVL2(MAX(num), MAX(num)+1, 1) FROM FREEBOARD";
		ResultSet rs = null;
	...
	public NoticeDTO read2(int num) {
		NoticeDTO dto = null;
	...
	public NoticeDTO updateui2(int num) {
		NoticeDTO dto = null;
	...
	public void update2(NoticeDTO dto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		String sql = "UPDATE FREEBOARD SET author = ?, title = ?, content = ?, writeday=sysdate WHERE num = ?";
	...
	public void reply2(int orinum, NoticeDTO repdto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		...
		try {
			...
			NoticeDTO oridto = updateui2(orinum);
	...
	private void increaseRepstepOtherReply(Connection conn, NoticeDTO oridto) {
		PreparedStatement pstmt = null;
		String sql = "UPDATE FREEBOARD SET repstep = repstep + 1 " + "WHERE reproot = ? AND repstep > ?";
	...
	public void increaseReadcnt(Connection conn, int num) {
		PreparedStatement pstmt = null;
		String sql = "UPDATE FREEBOARD SET readcnt = readcnt + 1 WHERE num = ?";
