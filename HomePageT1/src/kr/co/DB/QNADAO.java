...
public class QNADAO {
	...
	private int getNum(Connection conn) {
		int num = -1;
		PreparedStatement pstmt = null;
		String sql = "SELECT NVL2(MAX(num), MAX(num)+1, 1) FROM QNA";
		ResultSet rs = null;
	...
	public NoticeDTO read3(int num) {
		NoticeDTO dto = null;
	...
	public NoticeDTO updateui3(int num) {
		NoticeDTO dto = null;
	...
	public void update3(NoticeDTO dto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
	...
	public void reply3(int orinum, NoticeDTO repdto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		...
		try {
			...
			NoticeDTO oridto = updateui3(orinum);
