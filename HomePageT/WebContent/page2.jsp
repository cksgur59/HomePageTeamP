...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <c:if test="${to.beginlinenum - to.perline > 0}">
    	<a href="notice.do?curpage=${to.beginlinenum - to.perline}">&laquo;</a>
    </c:if>
    
    <c:if test="${to.curpage > 1}">
    	<a href="notice.do?curpage=${to.curpage - 1}">&lt;</a>
    </c:if>	
    
    <c:forEach var="i" end="${to.stoplinenum}" begin="${to.beginlinenum}">
    	<a class="${to.curpage == i?'itsme':''}" href="notice.do?curpage=${i}"> ${i} </a>
    </c:forEach>
    ...
    <c:if test="${to.totalpage > to.stoplinenum}">
    	<a href="notice.do?curpage=${to.beginlinenum + to.perline}">&raquo;</a>
=======
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
...
>>>>>>> 622429231e1940fda33bab1f04af7f45cc6892c4:HomePageT1/WebContent/page2.jsp
    </c:if>	